  ...
  return function() {
    ...
    if (args.length === 3) {
      ...
      if (_.isString(args[0]) && _.isFunction(args[1]) && isParams(args[2])) {
        var parsed = parseTaskAndParams(args[0]);
        var params = _.assign({}, parseParams(args[2]), parsed.params);
